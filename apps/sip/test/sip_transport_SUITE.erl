...
% test cases
-export([send_request_udp/1, send_request_udp_fallback/1, send_request_udp_multicast/1]).
...
-export([receive_request_send_response_tcp/1, receive_request_send_response_tcp_reconnect/1]).
...
end_per_group(_Group, Config) -> ok.
...
send_request_udp_fallback(Config) ->
